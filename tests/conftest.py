...
def make_event(db, station_id="STN-042", is_charging=True, received_at=None):
    """
...
def make_alert(db, station_id="STN-042", status=models.AlertStatus.open):
    """
