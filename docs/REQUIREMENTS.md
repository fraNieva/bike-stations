...
Business and technical requirements gathered from the client (CityBike maintenance team).

## Context

CityBike operates 256 electric bike stations in a big city. The bikes are provided by BikeCo,
...
- Station IDs must match the existing BikeCo station identifiers
...
- Single user for POC: maintenance manager
